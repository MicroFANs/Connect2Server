...
public class PointProcessBar extends View {
     ...
     * 连线的高度
     */
    float mLineHeight = 10f;
    //圆的直径
    float mCircleHeight = 55f;
     ...
     * 选中时的颜色
     */
    private int mColorSelected = Color.parseColor("#FF33B5E5");
    /**
     * 未选中的文字颜色
     */
    ...
    private void initPaint() {
        ...
        mTextPaint.setColor(mColorTextUnselected);
    ...
    private void measureHeight() {
        if (mBounds != null && mBounds.size() != 0) {
            defaultHeight = (int) (mCircleHeight + mMarginTop + mCircleSelStroke + mBounds.get(0).height());
        } else {
